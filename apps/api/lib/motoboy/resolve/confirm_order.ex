defmodule Motoboy.Resolve.ConfirmOrder do
  ...
  defp add_to_history(order_id, motoboy_id) do
    Repo.insert(%History{scope: "motoboy", text: "Confirmou pedido", order_id: order_id, motoboy_id: motoboy_id})
    Repo.insert(%History{scope: "order", text: "Pedido confirmado", order_id: order_id, motoboy_id: motoboy_id})
  end
end
