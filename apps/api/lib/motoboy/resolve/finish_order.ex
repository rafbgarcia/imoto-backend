defmodule Motoboy.Resolve.FinishOrder do
  ...
  defp add_to_history(order_id, motoboy_id) do
    Repo.insert(%History{scope: "order", text: "Pedido finalizado", order_id: order_id, motoboy_id: motoboy_id})
    Repo.insert(%History{scope: "motoboy", text: "Finalizou pedido", order_id: order_id, motoboy_id: motoboy_id})
  end
end
